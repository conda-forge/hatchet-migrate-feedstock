      ...
      <details>
        ...
        <table>
          ...
          <tbody><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=28381&branchName=main">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/hatchet-migrate-feedstock?branchName=main&jobName=osx&configuration=osx%20osx_arm64_" alt="variant">
                </a>
              </td>
            </tr>
          </tbody>
...
pixi add hatchet-migrate
# for installing globally
pixi global install hatchet-migrate
```
...
It is possible to list all of the versions of `hatchet-migrate` available on your platform:
...
```
pixi search hatchet-migrate --channel conda-forge
```
